...
function($) {
    ...
    if (o.show().lazyload({
        ...
        $("#navabout").hoverIntent(function() {
            m.removeClass("active"), $(this).addClass("active"), s.load("./menus/about.html").fadeIn(200), $("#d_admissions,#d_academics,#d_research,#d_medicine,#d_civic,#d_campuslife,#d_global").fadeOut(450)
        }, function() {
